...
function AllProduct() {
  ...
  return  isLoading ? (
    <div className="text-center">
      <div role="status">
          <svg className="inline mr-2 w-20 h-56 mt-24 text-peach animate-spin dark:text-gray-600 fill-red" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
