...
function Header() {
  ...
  return (
    ...
    <div className="toggle hidden w-full md:w-auto md:ml-52 md:flex text-left text-bold mt-5 md:mt-0">        
      ...
      <Scroll to="contacts" spy={true} smooth={true} offset={90} duration={300} className="block md:inline-block text-black hover:text-red-900 px-3 py-3 cursor-pointer">Contact</Scroll>
    </div>
